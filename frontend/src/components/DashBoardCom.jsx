...
const DashBoardCom = () => {
  ...
  useEffect(() => {
    const userPostCommentsFetch = async () => {
      try {
        const res = await fetch(
          `/api/v1/comment/getallcomments?userId=${currentUser._id}&limit=5`,
        );
    ...
    const AdminPostCommentsFetch = async () => {
      try {
        const res = await fetch('/api/v1/comment/getallcomments?limit=5');
        const data = await res.json();
    ...
    const fetchUserPosts = async () => {
      const res = await fetch(
        `/api/v1/post/getposts?userId=${currentUser._id}&limit=5`,
      );
      const data = await res.json();
      setPosts(data.posts);
    ...
    const userFetch = async () => {
      try {
        const res = await fetch('/api/v1/user/users?limit=5');
        const data = await res.json();
